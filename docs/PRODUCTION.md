...
STAND_TLS_DIRECTIVE=tls /lego/certificates/_.stand.example.com.crt /lego/certificates/_.stand.example.com.key
```
...
Сертификаты сохраняются в `storage/lego`, монтируются в Caddy как `/lego`, а
